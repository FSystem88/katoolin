...
def main():
 ...
 \033[1;36m$$ |\$$\  $$  __$$ |  $$ |$$\ $$ |  $$ |$$ |  $$ |$$ |$$ |$$ |  $$ |
 $$ | \$$\ \$$$$$$$ |  \$$$$  |\$$$$$$  |\$$$$$$  |$$ |$$ |$$ |  $$ |
 \__|  \__| \_______|   \____/  \______/  \______/ \__|\__|\__|  \__| V3.0\033[1;m


 \033[1;32m\tAuthor: LionSec | Homepage: www.neodrix.com\033[1;m
 \033[1;32m\tOriginal (v2.0): https://github.com/LionSec/katoolin\033[1;m 
...
\033[1;91mBefore updating your system , please remove all Kali-linux repositories to avoid any kind of problem .\033[1;m
...
5) Remove all kali linux repositories
			''')
				...
				if opcion0 == "1":
					...
					cmd4 = os.system("clear")
					print("\033[1;32m\nKali repositories was installed and updated!\033[1;m")
				elif opcion0 == "2":
					...
					cmd4 = os.system("clear")
					print("\032[1;32m\nAll programs was installed!\033[1;m")
				elif opcion0 == "3":
					print (''' 
...
''')
					repo = raw_input("\033[1;36mDo you want to install classicmenu indicator ? [y/n]> \033[1;m")
					if repo == "y":
						...
						cmd4 = os.system("clear")
						print("\033[1;32m\nClassicmenu indicator was installed!\033[1;m")
					else:
						cmd4 = os.system("clear")
						print ("\033[1;31m\nThe request was canceled!\033[1;m")
				elif opcion0 == "4":
					repo = raw_input("\033[1;36mDo you want to install Kali menu ? [y/n]> \033[1;m")
					if repo == "y":
						cmd1 = os.system("apt-get install kali-menu")
						cmd4 = os.system("clear")
						print ("\033[1;32m\nKali menu was installed!\033[1;m")
					else:
						cmd4 = os.system("clear")
						print ("\033[1;31m\nThe request was canceled!\033[1;m")
				elif opcion0 == "5":
					...
					fout.close()
					cmd4 = os.system("clear")
					print ("\033[1;32m\nAll kali linux repositories have been deleted!\033[1;m")
